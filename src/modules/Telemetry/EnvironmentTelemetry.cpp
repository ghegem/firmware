...
// adjust temp and humidity offset to t-echo values - calibrated w/ mijia sensor
...
bool EnvironmentTelemetryModule::getEnvironmentTelemetry(meshtastic_Telemetry *m)
{
    ...
    if (valid)  // apply temp and humidity offset to t-echo values - calibrated w/ mijia sensor
